#include "../quadratic/fitness.h"
//#include "../subsetsum/fitness.h"
#include "../quadratic/chromosome.h"
#include "../quadratic/gene.h"
//#include "../subsetsum/chromosome.h"
...
void testMutation() {
    ...
    BinaryStringCh *c = new BinaryStringCh(32);
    c->printGenotype();
    c->printPhenotype();
...
void testCrossover() {
    ...
    BinaryStringCh *c2 = new BinaryStringCh(32);
    c2->printGenotype();
    c2->printPhenotype();
